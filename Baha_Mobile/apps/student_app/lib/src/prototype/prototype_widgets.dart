...
class GlassPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ).animate().fadeIn(duration: 420.ms).slideY(begin: .06, end: 0);
  }
}
...
class AnimatedPrimaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FilledButton.icon(
      ...
      icon: Icon(icon),
      label: Text(label),
    ).animate().shimmer(duration: 1600.ms, delay: 900.ms);
  }
}
  ...
  Widget build(BuildContext context) {
    return Transform.rotate(
          ...
          child: CircleAvatar(
            ...
            child: Icon(palette.heroIcon, color: palette.primary, size: 34),
          ),
        )
