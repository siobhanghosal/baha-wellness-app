...
- Screen ID: `P-00`
- Screen Name: `Splash`
- Description: Loads consent status and linked student relationships.
...
- Header: Clear summary-first app bar with title, linked-student switcher when multiple children are linked, and notification entry point. Screen title is 'Splash'.
...
- Diagram File: [Mermaid/Parent_Splash.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Parent_Splash.mmd)
