...
- Screen ID: `P-11`
- Screen Name: `Alert Notification Detail`
- Description: Explains safeguarding-driven contact or action.
...
- Header: Clear summary-first app bar with title, linked-student switcher when multiple children are linked, and notification entry point. Screen title is 'Alert Notification Detail'.
...
- Cards: Use cards to present the main units of information on 'Alert Notification Detail'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Alert Notification Detail' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Alert Notification Detail' is missing or delayed.
...
- Diagram File: [Mermaid/Parent_Alert_Notification_Detail.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Parent_Alert_Notification_Detail.mmd)
