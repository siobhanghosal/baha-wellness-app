...
- Screen ID: `B-06`
- Screen Name: `Emergency Protocol View`
- Description: Guides acute safety steps and hotline surfacing.
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Emergency Protocol View'.
...
- Cards: Use cards to present the main units of information on 'Emergency Protocol View'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Emergency Protocol View' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Emergency Protocol View' is missing or delayed.
...
- Diagram File: [Mermaid/BAHA_Emergency_Protocol_View.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Emergency_Protocol_View.mmd)
