# B-13 - Pilot Analytics Dashboard

## Core Identity

- Screen ID: `B-13`
- Screen Name: `Pilot Analytics Dashboard`
- Description: Aggregate engagement, content, and escalation metrics.
...
- Refresh: Pilot Analytics Dashboard
...
- Deep Links:
- /baha/pilot_analytics_dashboard
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Pilot Analytics Dashboard'.
...
- Cards: Use cards to present the main units of information on 'Pilot Analytics Dashboard'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Pilot Analytics Dashboard' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Pilot Analytics Dashboard' is missing or delayed.
- User loses connectivity during interaction and resumes later.
- Role entitlement changes while the session is active.

## Mermaid Reference

- Diagram File: [Mermaid/BAHA_Pilot_Analytics_Dashboard.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Pilot_Analytics_Dashboard.mmd)
