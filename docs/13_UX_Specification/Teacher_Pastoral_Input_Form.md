# T-05 - Pastoral Input Form

## Core Identity

- Screen ID: `T-05`
- Screen Name: `Pastoral Input Form`
- Description: Structured categories and short free-text note.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Pastoral Input Form'.
...
- Cards: Use cards to present the main units of information on 'Pastoral Input Form'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Pastoral Input Form' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Pastoral Input Form' is missing or delayed.
...
- Diagram File: [Mermaid/Teacher_Pastoral_Input_Form.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Pastoral_Input_Form.mmd)
