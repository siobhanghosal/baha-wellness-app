...
- Screen ID: `T-09`
- Screen Name: `Teacher Learning Home`
- Description: Safeguarding, dashboard interpretation, and conversation content.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Teacher Learning Home'.
...
- Cards: Use cards to present the main units of information on 'Teacher Learning Home'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Teacher Learning Home' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Teacher Learning Home' is missing or delayed.
- User loses connectivity during interaction and resumes later.
- Role entitlement changes while the session is active.

## Mermaid Reference

- Diagram File: [Mermaid/Teacher_Teacher_Learning_Home.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Teacher_Learning_Home.mmd)
