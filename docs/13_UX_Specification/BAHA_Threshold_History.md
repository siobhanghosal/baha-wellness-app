...
- Screen ID: `B-12`
- Screen Name: `Threshold History`
- Description: Shows calibration changes and owner approvals.
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Threshold History'.
...
- Cards: Use cards to present the main units of information on 'Threshold History'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Threshold History' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Threshold History' is missing or delayed.
...
- Diagram File: [Mermaid/BAHA_Threshold_History.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Threshold_History.mmd)
