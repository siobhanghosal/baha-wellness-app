# S-29 - Safe Questions Library

## Core Identity

- Screen ID: `S-29`
- Screen Name: `Safe Questions Library`
- Description: Curated BAHA-reviewed question list.
...
- Header: Top app bar with age-appropriate title, back affordance when not top-level, and optional help action. Screen title is 'Safe Questions Library'.
...
- Cards: Use cards to present the main units of information on 'Safe Questions Library'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Safe Questions Library' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Safe Questions Library' is missing or delayed.
...
- Diagram File: [Mermaid/Student_Safe_Questions_Library.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Student_Safe_Questions_Library.mmd)
