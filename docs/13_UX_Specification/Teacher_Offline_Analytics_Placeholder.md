# T-14 - Offline Analytics Placeholder

## Core Identity

- Screen ID: `T-14`
- Screen Name: `Offline Analytics Placeholder`
- Description: Explains trend data sync dependency.
- User Goal: Complete the primary task implied by the screen name and PRD purpose without ambiguity or hidden policy risk.
- User Persona: Teacher or school counselor using anonymized class-level wellbeing insights and referral tools.
...
- School scope is loaded from the staff assignment.
- Required training completion gate passed if the feature exposes sensitive workflows.
- Exit Conditions:
...
- Refresh: Offline Analytics Placeholder
...
- Deep Links:
- /teacher/offline_analytics_placeholder
...
- This route is only available inside the Teacher application shell.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Offline Analytics Placeholder'.
- Footer: No persistent footer; footer space is reserved for anonymization notices and safeguarding disclaimers.
- Navigation Bar: Bottom or tab navigation with Dashboard, Pastoral Input, Referrals, Learn, and Settings.
...
- Cards: Use cards to present the main units of information on 'Offline Analytics Placeholder'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Offline Analytics Placeholder' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- School scope assignment
- Training completion for sensitive features
...
- Edge Cases:
- Upstream payload for 'Offline Analytics Placeholder' is missing or delayed.
- User loses connectivity during interaction and resumes later.
- Role entitlement changes while the session is active.

## Mermaid Reference

- Diagram File: [Mermaid/Teacher_Offline_Analytics_Placeholder.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Offline_Analytics_Placeholder.mmd)
