# T-06 - Pastoral Input Confirmation

## Core Identity

- Screen ID: `T-06`
- Screen Name: `Pastoral Input Confirmation`
- Description: Confirms submission and retention handling.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Pastoral Input Confirmation'.
...
- Cards: Use cards to present the main units of information on 'Pastoral Input Confirmation'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Pastoral Input Confirmation' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Pastoral Input Confirmation' is missing or delayed.
...
- Diagram File: [Mermaid/Teacher_Pastoral_Input_Confirmation.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Pastoral_Input_Confirmation.mmd)
