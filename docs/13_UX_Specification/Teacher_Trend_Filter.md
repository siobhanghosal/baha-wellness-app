...
- Screen ID: `T-04`
- Screen Name: `Trend Filter`
- Description: Switches week, cohort, and theme views.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Trend Filter'.
...
- Cards: Use cards to present the main units of information on 'Trend Filter'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Trend Filter' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Trend Filter' is missing or delayed.
...
- Diagram File: [Mermaid/Teacher_Trend_Filter.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Trend_Filter.mmd)
