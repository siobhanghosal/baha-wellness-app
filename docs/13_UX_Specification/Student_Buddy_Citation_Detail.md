...
- Screen ID: `S-31`
- Screen Name: `Buddy Citation Detail`
- Description: Shows source provenance and review date.
...
- Header: Top app bar with age-appropriate title, back affordance when not top-level, and optional help action. Screen title is 'Buddy Citation Detail'.
...
- Cards: Use cards to present the main units of information on 'Buddy Citation Detail'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Buddy Citation Detail' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Buddy Citation Detail' is missing or delayed.
...
- Diagram File: [Mermaid/Student_Buddy_Citation_Detail.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Student_Buddy_Citation_Detail.mmd)
