# T-11 - Restricted Student Case Notice

## Core Identity

- Screen ID: `T-11`
- Screen Name: `Restricted Student Case Notice`
- Description: Explains why direct access is blocked.
...
- Deep Links:
- /teacher/restricted_student_case_notice
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Restricted Student Case Notice'.
...
- Cards: Use cards to present the main units of information on 'Restricted Student Case Notice'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Restricted Student Case Notice' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Restricted Student Case Notice' is missing or delayed.
...
- Diagram File: [Mermaid/Teacher_Restricted_Student_Case_Notice.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Restricted_Student_Case_Notice.mmd)
