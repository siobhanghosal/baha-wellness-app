# P-07 - Sleep and Mood Trend Explanation

## Core Identity

- Screen ID: `P-07`
- Screen Name: `Sleep and Mood Trend Explanation`
- Description: Explains trend direction without raw entries.
...
- Header: Clear summary-first app bar with title, linked-student switcher when multiple children are linked, and notification entry point. Screen title is 'Sleep and Mood Trend Explanation'.
...
- Cards: Use cards to present the main units of information on 'Sleep and Mood Trend Explanation'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Sleep and Mood Trend Explanation' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Sleep and Mood Trend Explanation' is missing or delayed.
...
- Diagram File: [Mermaid/Parent_Sleep_and_Mood_Trend_Explanation.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Parent_Sleep_and_Mood_Trend_Explanation.mmd)
