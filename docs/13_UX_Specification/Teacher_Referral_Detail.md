...
- Description: Shows referral metadata and counselor actions allowed to teacher.
...
- Header: Operational app bar with school context, cohort selector, and referral/notification shortcuts. Screen title is 'Referral Detail'.
...
- Cards: Use cards to present the main units of information on 'Referral Detail'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Referral Detail' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Referral Detail' is missing or delayed.
...
- Diagram File: [Mermaid/Teacher_Referral_Detail.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Teacher_Referral_Detail.mmd)
