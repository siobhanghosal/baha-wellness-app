# B-11 - Threshold Configuration

## Core Identity

- Screen ID: `B-11`
- Screen Name: `Threshold Configuration`
- Description: Manages rule thresholds per school and age group.
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Threshold Configuration'.
...
- Cards: Use cards to present the main units of information on 'Threshold Configuration'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Threshold Configuration' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Threshold Configuration' is missing or delayed.
...
- Diagram File: [Mermaid/BAHA_Threshold_Configuration.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Threshold_Configuration.mmd)
