...
- Screen ID: `S-13`
- Screen Name: `Check-In Completion`
- Description: Confirms completion and directs to calming or learning suggestions.
...
- Header: Top app bar with age-appropriate title, back affordance when not top-level, and optional help action. Screen title is 'Check-In Completion'.
...
- Cards: Use cards to present the main units of information on 'Check-In Completion'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Check-In Completion' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Check-In Completion' is missing or delayed.
...
- Diagram File: [Mermaid/Student_Check_In_Completion.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/Student_Check_In_Completion.mmd)
