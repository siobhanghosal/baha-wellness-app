...
- Screen ID: `B-00`
- Screen Name: `Splash`
- Description: Loads role, permissions, and operational context.
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Splash'.
...
- Diagram File: [Mermaid/BAHA_Splash.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Splash.mmd)
