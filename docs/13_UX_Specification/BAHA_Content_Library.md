# B-07 - Content Library

## Core Identity

- Screen ID: `B-07`
- Screen Name: `Content Library`
- Description: Lists drafts, reviewed, published, flagged, and archived items.
...
- Header: Dense operational header with role context, queue counters, filters, and export or action shortcuts. Screen title is 'Content Library'.
...
- Cards: Use cards to present the main units of information on 'Content Library'. Cards should expose status, summary metadata, a primary action, and a clear affordance for deeper detail.
...
- Empty States: If 'Content Library' has no data, show a role-appropriate explanation, why the state is empty, and the single next best action. Never show a blank surface.
...
- Edge Cases:
- Upstream payload for 'Content Library' is missing or delayed.
...
- Diagram File: [Mermaid/BAHA_Content_Library.mmd](/Users/solomonkaruppiah/Desktop/Baha_Data/docs/13_UX_Specification/Mermaid/BAHA_Content_Library.mmd)
