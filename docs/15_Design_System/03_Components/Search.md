...
Keyword lookup across content, audit, queue, notification, and support-oriented list surfaces.

## Variants

- Inline search bar
- Collapsed search action
- Search with filters
...
- Used in high-volume list views such as content libraries, audit logs, queues, and notification centers.
- Prefer composition through shared slots and semantic tokens instead of one-off overrides.

## Do

- Debounce remote queries and preserve entered text
- Show the active search term near results

## Don't

- Clear the query on route refresh
- Hide matching-zero states without explanation

## Flutter Widget Mapping

- `SearchBar, TextField with InputDecorator, custom sliver search header`

## Figma Component Mapping

- `Search / Mode={Mode} / State={State}`
